...
(function($) {
    ...
    $('.countdown').countdown(countdown_date, function(event) {
        $('.dday').html(event.strftime('%-D').padStart(2, '0'));
        $('.dhour').html(event.strftime('%-H').padStart(2, '0'));
        $('.dmin').html(event.strftime('%-M').padStart(2, '0'));
        $('.dsec').html(event.strftime('%-S').padStart(2, '0'));
    });
